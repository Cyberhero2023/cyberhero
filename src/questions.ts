export default [
	...
	{
		"question": "Why is it important to protect your accounts online?",
		"options": [
			"Protecting personal and financial information",
			"Protecting virtual pets",
	...
	},
	{
		"question": "What is phishing?",
		"options": [
			"It is a kind of cyber attack where criminals use fake emails, text messages or websites to extort sensitive information about you",
			"A recently invented method of fishing that is more effective than a fishing rod",
	...
	{
		"question": "Which of the following information is ok to share online?",
		"options": [
			"Your full name to strangers online",
			"Your password to your email address",
	...
	{
		"question": "Should you browse your email, or banking accounts while on a public network?",
		"options": [
	...
	{
		"question": "Is it ok to share personal information online?",
		"options": [
	...
	{
		"question": "How can you tell a phishing email from a safe email?",
		"options": [
			"Phishing emails are sent from unknown or suspicious senders",
			"Phishing emails have typos and/or weird email formatting",
	...
	{
		"question": "How can you tell if the website you are using is safe to browse?",
		"options": [
			"The website URL starts with https (\"s\" standing for secure)",
			"The website has a trusted certificate",
	...
	{
		"question": "What is a good habit to have when using the internet?",
		"options": [
	...
	{
		"question": "What is a safe way to keep your password?",
		"options": [
	...
	{
		"question": "Why is it important to not click on links from unknown sources?",
		"options": [
			"It could lead to a virus",
			"It could lead to a phishing scam",
	...
	{
		"question": "What is a good habit to have when creating an online account?",
		"options": [
			"Using your home address as your username",
	...
	{
		"question": "What is a good habit to have when shopping online?",
		"options": [
			"Using your credit card number on all websites",
